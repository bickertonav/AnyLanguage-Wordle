export const CONFIG = {
  ...
  language: 'Kreyòl', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Avery Bickerton', // Put your name here so people know who made this Wordle!
  wordListSource: 'EZ Glot', // Describe the source material for your words here
  wordListSourceLink: 'https://www.ezglot.com', // Put a link to the source material for your words here
  //
